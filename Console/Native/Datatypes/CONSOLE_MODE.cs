...
{
    /// <summary>
    /// The current mode of the specified buffer.
    /// </summary>
    /// <remarks>
    /// Comments source: https://docs.microsoft.com/en-us/windows/console/getconsolemode
    /// </remarks>
    [Flags]
    internal enum CONSOLE_MODE : Int32
    {
        // Input modes
        ...
        /// location and all text following that location will not be overwritten.
        /// </summary>
        ...
        /// when the cursor advances beyond the last row in the console screen buffer. If this mode
        /// is disabled, the last character in the row is overwritten with any subsequent characters.
        /// </summary>
        ...
        /// operations that can also be performed via the existing Console APIs. For more
        ...
        /// ENABLE_WRAP_AT_EOL_OUTPUT is on. No overwrite will occur. Specifically, the cursor
        ...
        /// the final character on the screen (in the bottom right corner) without triggering an
        ...
        /// was specified with the COMMON_LVB prefix. Historically, these flags only functioned in
        /// DBCS code pages for Chinese, Japanese, and Korean languages. With exception of the
        /// leading byte and trailing byte flags, the remaining flags describing line drawing and
        /// reverse video (swap foreground and background colors) can be useful for other languages
        /// to emphasize portions of output.
        ///
        /// With exception of the leading byte and trailing byte flags, the remaining flags
        /// describing line drawing and reverse video (swap foreground and background colors) can be
        /// useful for other languages to emphasize portions of output.
        ///
        /// Setting this console mode flag will allow these attributes to be used in every code page
        /// on every language.
        ///
