...
namespace LastHarbor.Console.Native
{
    ...
    internal static partial class NativeMethods
    {
        ...
        /// A pointer to a <see cref="CONSOLE_SCREEN_BUFFER_INFO"/> structure that receives the
        ...
        /// <see cref="CONSOLE_SCREEN_BUFFER_INFO"/> structure can be modified and then passed to the
        /// <see cref="SetConsoleWindowInfo"/> function to scroll the console screen buffer in the
        /// window, to change the size of the window, or both.
        /// </para>
        /// <para>
        /// All coordinates returned in the <c>CONSOLE_SCREEN_BUFFER_INFO"</c> structure are in
        /// character-cell coordinates, where the origin (0, 0) is at the upper-left corner of the
        /// console screen buffer.
        /// </para>
        /// </remarks>
        /// <seealso href="https://docs.microsoft.com/en-us/windows/console/getconsolescreenbufferinfo"/>
        ///
